...
"""
EXPERIMENTAL — Maximized Enterprise Candidate Job-Fit ML Ranker
================================================================
⚠️ This model is trained on SYNTHETIC data with a hand-crafted decision
boundary. It has NOT been trained on real hiring outcomes. Predictions
reflect the author's assumptions about feature weights, not empirical
evidence. Use for experimentation / R&D only — do not treat scores as
ground truth for hiring decisions.
    ...
    def predict(self, candidate_metrics: Dict[str, float]) -> Dict[str, Any]:
        ...
        return {
            ...
            "experimental_warning": (
                "This score is generated by a model trained on synthetic data, "
                "not real hiring outcomes. Use for experimentation only."
            ),
            "feature_importances": self.feature_importances_,
            "input_metrics": {
                "mcq_score_pct": mcq,
