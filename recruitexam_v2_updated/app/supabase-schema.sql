...
alter table exams add column if not exists negative_marking numeric default 0;
...
-- Ensure scheduling columns exist even if ai_interviews was created earlier
